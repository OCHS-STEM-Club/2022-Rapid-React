...
public class Potentiometer {
    ...
    public void hoodPotentiometer(){
      ...
      public void hoodMotor2() {
        if (controller.getRawButton(4) && hoodPotentiometer.get() > 0.15) {
          hoodMotor.set(ControlMode.PercentOutput, 0.25);
        } else if (controller.getRawButton(4) && hoodPotentiometer.get() < 0.1) {
          hoodMotor.set(ControlMode.PercentOutput, -0.25);
        }
      } 

        public void hoodMotor3() {
        if (controller.getRawButton(3) && hoodPotentiometer.get() > 0.075) {
          hoodMotor.set(ControlMode.PercentOutput, 0.15);
        } else if (controller.getRawButton(3) && hoodPotentiometer.get() < 0.072) {
          hoodMotor.set(ControlMode.PercentOutput, -0.15);
        } 
